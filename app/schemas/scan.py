...
class ScanRequest(BaseModel):
    ...
    ports: Optional[str] = Field(None, description="Ejemplo: '22,80,443' o '1-1024'")


# Scaneo por rango o CIDR
class RangeScanRequest(BaseModel):
    network: str = Field(..., description="CIDR Ej: 192.168.1.0/24")
    ports: Optional[str] = Field(None, description="Ejemplo: '22,80' o '1-1024'")
